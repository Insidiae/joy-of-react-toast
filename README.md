...
This project is a fork of the [original version as shown in The Joy of React](https://github.com/joy-of-react/project-toast). The only major difference is that this version uses [TypeScript](https://www.typescriptlang.org/) for the solution files and [Vite](https://vitejs.dev/) as the build tool. This project should run exactly the same way as the original version. It's intended to be run locally, on your computer, using Node.js and NPM.
